...
<body>
    <div class="xywarp">
        <div class="content">
            ...
            <br>
            <br>
            <p style="text-align: right;">协议编号：（<?php echo $bianhao; ?>）</p>
            <br>
            <br>
            <p>本协议由以下各方于___<?php echo date('Y', time());?>___年___<?php echo date('m', time());?>___月___<?php echo date('d', time());?>___日在深圳市____福田区____签订：</p>
            <br>
            <br>
            ...
            <table border="1" style="margin: 0px auto; font-size:14px; border-collapse: collapse; border: 1px solid #000; width: 80%; ">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px">大写：<?php echo $jiekuanjine ?>（小写：__<?php echo $product['stock_money']; ?>__元）</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; width: 20%;  padding: 10px">借款年化利率</td>
                        <td style="padding: 10px">__<?php echo $product['year_rate']; ?>__%</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; padding: 10px; width: 20%; ">借款期限</td>
                        <td style="padding: 10px; line-height: 25px;">__<?php echo intval($product['invest_day']/30); ?>__个月，__<?php echo date('Y',$product['start_time']); ?>__年__<?php echo date('m',$product['start_time']); ?>__月__<?php echo date('d',$product['start_time']); ?>__日起至__<?php echo date('Y',$product['end_time']); ?>__年__<?php echo date('m',$product['end_time']); ?>__月__<?php echo date('d',$product['end_time']); ?>__日止（实际借款起始日期以甲方出借资金划入乙方资金账户之日为准，借款天数不变，借款截至日期随起始日期的变动而相应变动）</td>
                    </tr>
                    <tr>
            ...
            <p style="text-indent: 25px; ">3.1 本协议约定甲方依照以下第__
                <?php 
            ...
            <p style="text-indent: 25px; ">b．先息后本：即还款利息_____元/月，最后一期还款本金_____元；</p>
                ...
                <tbody>
                    ...
                    <?php foreach ($huankuan as $key => $value) : ?>
                        <tr>
                            ...
                            <td style="padding: 10px;text-align: center;"><?php echo date('Y-m-d', $value['create_time']); ?></td>
            ...
            <p style="text-indent: 25px; ">经各方协商，甲方选择___<?php echo $product['warranty_type']; ?>__方式对本合同项下借款进行保证。</p>
            <p style="text-indent: 25px; ">4.1 质押保证</p>
            <p style="text-indent: 25px; ">机动车质押作为乙方在丙方平台借款的保证，乙方将自己名下的汽车：</p>
            <p style="text-indent: 25px; ">牌照号为：_____<?php if($product['warranty_type'] == 1){echo $baozheng['plate_number'];}?>______；&nbsp;&nbsp;型号为：____<?php if($product['warranty_type'] == 1){echo $baozheng['model'];}?>_______；</p>
            <p style="text-indent: 25px; ">发动机号为：______<?php if($product['warranty_type'] == 1){echo $baozheng['engine_number'];}?>_______；&nbsp;&nbsp;车架号为：______<?php if($product['warranty_type'] == 1){echo $baozheng['vin'];}?>______。</p>
            ...
            <br>
            <p style="text-indent: 25px; ">甲方（签字盖章）：<?php echo $memgerinfo['realname']; ?></p>
            <br>
            ...
            <p style="text-indent: 25px; line-height:100px;width:300px;">丙方（签字盖章）：
                <img src="<?php echo $image_base_url; ?>" style="width:142px; float:right; height:142px;" />
            </p>
            
            <br>
            <p style="text-indent: 25px; ">授权代表签字：<?php echo $memgerinfo['realname']; ?></p>
            <br>
            <p style="text-indent: 25px; ">签约时间：<?php echo date('Y', time()); ?>年<?php echo date('m', time()); ?>月<?php echo date('d', time()); ?>日 </p>
            <br>
