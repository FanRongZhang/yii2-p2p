                ...
                <div class="con-loginbox">
                    ...
                    <div class="con-loginput2 clearfix">
                        <div class="con-input-mainst">
                            <input type="text" class="form-control mobile" placeholder="请输入已经注册的手机号码" name="LoginForm[mobile]" >
                        </div>
                    </div>
                    <div class="con-loginput2 clearfix">
                        <div class="con-input-mainst">
                            <input type="password" class="form-control password" placeholder="请输入密码" name="LoginForm[password]" >
                        </div>
                    </div>
                    <div class="con-loginput2 clearfix">
                        <div class="con-input-mainst form-group">
                            <input type="text" class="form-control loginborder" id="captcha" name="LoginForm[verifyCode]" size="6" maxlength="6" placeholder="验证码" limit="required:true" msg="验证码不能为空" title="请填写验证码" msgArea="try_info" style="width:150px;float:left;" />
...
<?php $this->beginBlock('test'); ?>
    ...
    $(function(){
        ...
        $(".login-btnter").click(function() {
            ...
            var loginborder = $.trim($('.loginborder').val());
            if(loginborder == ''){
                $(".con-error-prompt").show();
                $(".con-errorbox").text('验证码不能为空！');
                ok3 = false;
                return false
            }else{
                ok3 = true;
