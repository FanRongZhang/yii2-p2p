...
<div class="notice-box">
    <div class="q-wide">
        <div class="not-title clearfix">
            ...
            <div id="broadcast" class="newsbar clearfix fl">
            ...
            </div>            <div class="fr commmore"><a href="/index/index/newslist" >查看更多<i class="officicon moreicon"></i></a></div>
        </div>
    </div>
</div>
<!--notice end-->
                    ...
                    <div class="con-clo-main">
                        <div class="con-list-box">
                            <div class="con-indexts-box1">
                                <div class="con-list-tit"><span class="con-fnts"><a style="color:#000" href="<?php echo Url::to(['/index/index/detail', 'id'=>$value['id']]); ?>"><?php echo $value['name'] ?></a></span><span class="newsblues">新手专享</span></div>
                                <div class="con-times">
                            ...
                            <div class="con-main-clounmt clearfix">
                                <div class="fl per-box ied1">
                                    <div class="m01"><span class="f60 oranges"><?php echo rtrim(rtrim(rtrim($value['rate'], '%'),'0'),'.'); ?></span><span class="oranges f30">%</span></div>
                                ...
                                <div class="con-buttons fl"><a href="<?php echo Url::to(['/index/index/detail', 'id'=>$value['id']]); ?>" class="btn btnmains <?php if($value['pro_status'] != 1){echo 'btngrays';} ?>">
                                        <?php 
                                            if ($value['pro_status'] == 1) {
                                                echo "立即投资";
                                            } else if($value['pro_status'] == 2){
                                                echo "已满额";
                                            } else if($value['pro_status'] == 6){
                                                echo "还款中";
                                            }else{
                                                echo "已结束";
                                            }
            ...
            <?php if(is_array($dingqi) && !empty($dingqi)) :?>
                <?php foreach($dingqi as $k => $v) :?>
                    <div class="con-clo-main">
                        <div class="con-list-box">
                            <div class="con-indexts-box1">
                                <div class="con-list-tit"><span class="con-fnts"><a style="color:#000" href="<?php echo Url::to(['/index/index/detail', 'id'=>$v['id']]); ?>"><?php echo $v['name']; ?></a></span></div>
                                <div class="con-times">
                            ...
                            <div class="con-main-clounmt clearfix">
                                <div class="fl per-box ied1">
                                    <div class="m01"><span class="f60 oranges"><?php echo rtrim(rtrim(rtrim($v['rate'], '%'),'0'),'.'); ?></span><span class="oranges f30">%</span></div>
                                    <span class="gray1 f14">预期年化收益</span>
                                </div>
                                ...
                                <div class="con-buttons fl">
                                    <a href="<?php echo Url::to(['/index/index/detail', 'id'=>$v['id']]); ?>" class="btn btnmains <?php if($v['pro_status'] != 1){echo 'btngrays';} ?>">
                                        <?php 
                                            if ($v['pro_status'] == 1) {
                                                echo "立即投资";
                                            } else if($v['pro_status'] == 2){
                                                echo "已满额";
                                            } else if($v['pro_status'] == 6){
                                                echo "还款中";
                                            }else{
                                                echo "已结束";
                                            }
                            ...
                            <div class="clearfix con-main-clounmt2">
                                ...
                                <div class="fl marleft"><i class="officicon pr-in2"></i><span class="pad25 gray3">起投金额<?php echo $v['min_money']; ?>元</span></div>
                                <div class="fl marleft"><i class="officicon pr-in3"></i><span class="pad25 gray3">限投金额<?php echo $v['max_money']; ?>元</span></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach;?>
...
<?php $this->beginBlock('test'); ?>
    ...
    <?php foreach ($xinshou as $k => $value) { ?>
        ...
        addTimer("timer_xinshou", <?php  if($value['type']=='1'){ echo $value['end_time']/1000 ;}else{ echo 0;}?>);
    <?php } ?>

    <?php foreach ($dingqi as $k => $value) { ?>
        addTimer("timer_<?php echo $k ?>", <?php if($value['type']=='1'){ echo $value['end_time']/1000 ;}else{ echo 0;}?>);
    <?php } ?>
