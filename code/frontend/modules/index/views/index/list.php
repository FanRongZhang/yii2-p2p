		            ...
		            <div class="con-clo-main">
		                <div class="con-list-box">
		                    <div class="con-indexts-box1">
		                        <div class="con-list-tit"><span class="con-fnts"><a style="color:#000" href="<?php echo Url::to(['/index/index/detail', 'id'=>$v['id']]); ?>"><?php echo $v['product_name']; ?></a></span></div>
		                        <div class="con-times">
		                    ...
		                    <div class="con-main-clounmt clearfix">
		                        <div class="fl per-box ied1">
		                            <div class="m01"><span class="f60 oranges"><?php echo rtrim(rtrim($v['year_rate'], '0'),'.'); ?></span><span class="oranges f30">%</span></div>
...
<?php foreach($list as $k => $v){?>
    addTimer("timer_<?php echo $k?>", 
        <?php  if ( $v['status']=='1' && $v['end_time']-time() > 0){
