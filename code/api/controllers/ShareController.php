...
class ShareController extends Controller
{
    ...
    public function actionRegister(){
        ...
        if(Yii::$app->request->isPost){
            ...
            if($res){
                ...
                $params['password'] = EncryptService::twiceMd5($password);
        ...
        $this->getView()->title = "钱富宝Pro正式上线银行资金存管，让用户安心又省心";
        ...
        return $this->render('register',compact('flowList', 'realname', 'nickname', 'wxParam', 'member_id','mobile'));
    }
    ...
    public function actionSuccess()
    {
        ...
        $this->getView()->title = "钱富宝正式上线银行资金存管，让用户安心又省心";
        ...
        if(Yii::$app->request->isPost){
            ...
            if ($type == CommonService::VERIFY_TYPE_REG){
                ...
                if ($userModel){
                    ...
                    if (!empty($member_s))
                        return Json::encode(['code' => Code::COMMON_ERROR_CODE, 'msg' => '帐号已在钱富宝存在，请登录进行平移！']);
                    else
                        return Json::encode(['code' => Code::COMMON_ERROR_CODE, 'msg' => '手机号已注册！']);
                }
            }
