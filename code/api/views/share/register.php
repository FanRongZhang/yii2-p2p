...
<div class="qfb-cencertd">
			...
			<a href="javascript:;" class="logo fl"></a>
                <span class="make-wraps">
                    <i class="make-wrap-before"></i>
                           <span style="padding-top: 12px; display:inline-block">会赚钱的钱包</span>
                </span>
			<div class="qfb-btn-box qfb-btn-boxp">
				<a class="qfb-btn-btn iphone-load bomb-btn" href="https://itunes.apple.com/us/app/%E9%92%B1%E5%AF%8C%E5%AE%9Dpro/id1262960542?mt=8" style="display: none;">
					<img src="/img/down.gif"><span>下载APP</span>
				</a>
				<a class="qfb-btn-btn android-load abomb-btn" href="http://zhushou.360.cn/detail/index/soft_id/3873699?recrefer=SE_D_%E9%92%B1%E5%AF%8C%E5%AE%9DPro" style="display: none;"><img src="/img/down.gif"><span>下载APP</span></a>
			</div>
		</div>
	</div>
	<!--头部end-->
	...
	<div class="qfb-content">
		...
		<div class="addWrap">
			<div class="swipe" id="mySwipe" >
				<div class="swipe-wrap">
					<div><a href="javascript:;"><img class="img-responsive" src="/img/ad/banner1.png" title="banner1" alt=""></a></div>
					<div><a href="javascript:;"><img class="img-responsive" src="/img/ad/banner2.png" title="banner2" alt=""></a></div>
				</div>
			</div>
		...
		<div class="share-recommend">
			...
			您的好友<span> <?=$realname?> </span>邀请您注册钱富宝！
		</div>
		<?php endif; ?>
		...
		<div class="icontent-bottom">
			<img src="/img/ad/adber1.png" alt="" title="1">
			<img src="/img/ad/adber2.png" alt="" title="2">
			<img src="/img/ad/adber3.png" alt="" title="3">
		</div>
		<!-- 中间展示图片 eof -->
	</div>
	<!--内容end-->
		...
		<div class="qfb-footerbox">
			<ul class="btncl">
				...
				<li>
					...
					<a class="iphone-load bomb-btn" href="https://itunes.apple.com/us/app/%E9%92%B1%E5%AF%8C%E5%AE%9Dpro/id1262960542?mt=8" style="display: none;"><span>客户端</span></a>
					<a class="android-load abomb-btn" href="http://zhushou.360.cn/detail/index/soft_id/3873699?recrefer=SE_D_%E9%92%B1%E5%AF%8C%E5%AE%9DPro" style="display: none;"><span>客户端</span></a>
				</li>
			</ul>

			<p class="qfb-copyright1">Copyright©2013-2017 qianfb.com All Rights Reserved<br>钱富宝版权所有</p>
...
<script type="text/javascript">
	...
	function checkPassword()
	{
		...
		if(!password){
            ...
            $("#error_password").addClass("q-infored");
            $("#error_password").html('密码不可包含空格');
            return false
		}else if(!/^[0-9a-zA-Z]*$/g.test(password)){
            $("#error_password").addClass("q-infored");
            $("#error_password").html('密码不能包含特殊字符');
            return false
        }else{
