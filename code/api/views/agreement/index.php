...
<body>
    <div class="xywarp">
        <div class="content">
            ...
            <br>
            <br>
            <p>甲方（投资人）：<?php echo $memgerinfo['realname']; ?></p>
            <p>平台用户名：<?php echo $memgerinfo['account']; ?></p>
            <p>身份证号码：<?php echo $memgerinfo['card_no']; ?></p>
            ...
            <table border="1" style="margin: 0px auto; font-size:14px; border-collapse: collapse; border: 1px solid #000; width: 80%; ">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px; line-height: 25px;"><?php echo intval($product['invest_day']/30); ?>个月，<?php echo date('Y',$product['start_time']); ?> 年 <?php echo date('m',$product['start_time']); ?> 月 <?php echo date('d',$product['start_time']); ?> 日起至 <?php echo date('Y',$product['end_time']); ?> 年 <?php echo date('m',$product['end_time']); ?> 月 <?php echo date('d',$product['end_time']); ?> 日止（实际借款起始日期以甲方出借资金划入乙方资金账户之日为准，借款天数不变，借款截至日期随起始日期的变动而相应变动）</td>
                    </tr>
                    <tr>
            ...
            <p style="text-indent: 25px; line-height:100px;width:300px;">丙方（签字盖章）：
                <img src="../../../../img/gz.png" style="width:142px; float:right; height:142px;" />
            </p>
