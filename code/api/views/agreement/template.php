...
<head>
    ...
    <style type="text/css">
        ...
        .content{padding: 36px 20px; background: url(../../../../img/shuiyin.png) repeat-y center;}
...
<body>
    <div class="xywarp">
        <div class="content">
            ...
            <br>
            <br>
            <p>本协议由以下各方于______年______月______日在深圳市________签订：</p>
            <br>
            <br>
            <p>甲方（投资人）：</p>
            <p>平台用户名：</p>
            ...
            <table border="1" style="margin: 0px auto; font-size:14px; border-collapse: collapse; border: 1px solid #000; width: 80%; ">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px">大写：____仟____佰____拾____万____仟____佰____拾____元（小写：____元）</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; width: 20%;  padding: 10px">借款年化利率</td>
                        <td style="padding: 10px">____%</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; padding: 10px; width: 20%; ">借款期限</td>
                        <td style="padding: 10px; line-height: 25px;">____个月，____年____月____日起至____年____月____日止（实际借款起始日期以甲方出借资金划入乙方资金账户之日为准，借款天数不变，借款截至日期随起始日期的变动而相应变动）</td>
                    </tr>
                    <tr>
            ...
            <p style="text-indent: 25px; ">3.1 本协议约定甲方依照以下第_____种方式还本付息：</p>
            ...
            <table border="1" style="margin: 0px auto; font-size:14px; border-collapse: collapse; border: 1px solid #000; width: 80%; ">
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 10px;" colspan="2">合计</td>
                        <td style="padding: 10px;"></td>
                        <td style="padding: 10px;"></td>
                        <td style="padding: 10px;"></td>
                    </tr>
            ...
            <p style="text-indent: 25px; ">经各方协商，甲方选择_____方式对本合同项下借款进行保证。</p>
            <p style="text-indent: 25px; ">4.1 质押保证</p>
            <p style="text-indent: 25px; ">机动车质押作为乙方在丙方平台借款的保证，乙方将自己名下的汽车：</p>
            <p style="text-indent: 25px; ">牌照号为：______________________________；&nbsp;&nbsp;型号为：______________________________；</p>
            <p style="text-indent: 25px; ">发动机号为：______________________________；&nbsp;&nbsp;车架号为：______________________________。</p>
            <p style="text-indent: 25px; ">向丙方作质押，约定该车辆于乙方收到甲方借款时，交由丙方占有。</p>
            <p style="text-indent: 25px; ">具体内容见“质押合同”合同编码为（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）。</p>
            ...
            <p style="text-indent: 25px; ">具体内容见“抵押合同”合同编码为（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）。</p>
            <p style="text-indent: 25px; ">4.3 保证担保</p>
            <p style="text-indent: 25px; ">保证人：</p>
            <p style="text-indent: 25px; ">身份证号（或社会信用代码）：</p>
            <p style="text-indent: 25px; ">联系电话： </p>
            <p style="text-indent: 25px; ">本合同的保证方式为：       （①一般保证；②连带责任保证）</p>
            <p style="text-indent: 25px; ">具体内容见“保证合同”合同编码为（&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;）。</p>
            ...
            <br>
            <p style="text-indent: 25px; ">甲方（签字盖章）：以各投资人在投资时点击钱富宝Pro客户端“确认”按钮，生成电子合同，以示签字同意</p>
            <br>
            <p style="text-indent: 25px; ">乙方（签字盖章）：</p>
            <br>
            <p style="text-indent: 25px; ">丙方（签字盖章）： </p>
            <br>
            <p style="text-indent: 25px; ">授权代表签字：</p>
            <br>
            <p style="text-indent: 25px; ">签约时间：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日 </p>
            <br>
            <p style="text-indent: 25px; ">签约地点：</p>
