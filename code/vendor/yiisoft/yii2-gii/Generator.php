...
abstract class Generator extends Model
{
    ...
    public function init()
    {
		...
		$backendTemplate = dirname($class->getFileName()) . '/backend';			//��̨ģ��
		$frontendTemplate = dirname($class->getFileName()) . '/frontend';		//ǰ̨ģ��
		$weixinTemplate = dirname($class->getFileName()) . '/weixin';			//΢��ģ��
		$this->templates['backend']=$backendTemplate;
		$this->templates['frontend']=$frontendTemplate;
		$this->templates['weixin']=$weixinTemplate;
