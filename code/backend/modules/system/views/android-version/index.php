...
/* @var $searchModel backend\modules\system\models\AndroidVersionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', '安卓版本');
                ...
                ([
                    [
                        ...
                        function($url,$model,$key){
                            ...
                            //查询最新的一条记录
                            $new = QfbVersion::find()->where(['=','type',1])->orderBy('create_time desc')->limit(1)->one();
                            if ($model->id == $new->id) {
                                return Html::a('<span class="glyphicon glyphicon-pencil"></span>编辑', '/system/android-version/update?id='.$model->id, $options);
                            }
                        }
