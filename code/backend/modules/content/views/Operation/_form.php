...
<div class="create-form">
    ...
    <div class="row">
        <?= $form->field($model, 'phone',['options'=>['class'=>'control-group span8']])->textInput(['maxlength' => true]) ?>
    </div>

    <div class="row">
        <?= $form->field($model, 'time',['options'=>['class'=>'control-group span8']])->textInput(['maxlength' => true]) ?>
    </div>

    <div class="row">
        <?= $form->field($model, 'bottom',['options'=>['class'=>'control-group span8']])->textarea(['rows'=>3]) ?>
    </div>
