...
/* @var $searchModel backend\modules\content\models\baseNavigationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '底部导航管理';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="qfb-base-navigation-index">
    ...
    <p>
        ...
        if(AdminService::hasPermision($this,PermissionEnum::ADD))
            echo Html::a('添加底部导航', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                {
                    if($data->pid == 0) {
                        return HTML::encode('顶级');
                    } else {
                        $pidname=QfbBaseNavigation::getname($data->pid);
                        return HTML::encode($pidname);
                    }
                }
            ],
            [
