            ...
            <div class="fr clearfix q-topvipment">
                <ul>
                    ...
                    <?php if (empty($member_data)) { ?>
                        ...
                        <li><a href='/login/login/register' target='_blank'>注册</a></li>
                        <li><a href='/login/login/login' target='_blank'>登录</a></li>

                    <?php } else { ?>

                        <li><a href='#' target='_blank'>我的账户</a></li>
                        <li><a href='/login/login/logout' target='_blank'>退出登录</a></li>
                    ...
                    <div class="con-member">
                        ...
                        <div class="con-mem-list">
                            <ul>
                                ...
                                <li <?php if(\Yii::$app->controller->id == 'message') echo 'class="memb-acitves"'?>><a href="<?php echo Url::to(['message/index']);?>">消息（1）</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="con-member">
                        ...
                        <div class="con-mem-list">
                            <ul>
                                ...
                                if($member_data['member_type'] == 1){
                                    echo '<li '.\Yii::$app->controller->id == 'invest'?'class="memb-acitves"':''.'><a href="'.Url::to(['invest/index']).'">我的投资</a></li>';
                                }else{
