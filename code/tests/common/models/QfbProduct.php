...
class QfbProduct extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sn', 'product_type', 'product_name', 'min_money', 'max_money', 'step_money', 'has_money', 'stock_money', 'year_rate', 'lock_day', 'invest_day', 'profit_day', 'status','end_time','category_id', 'profit_type','is_newer','is_index','is_hidden','can_rate_ticket','can_money_ticket','member_id','platform_income'], 'required'],
            [['product_type', 'can_rate_ticket', 'can_money_ticket', 'is_newer', 'lock_day', 'invest_day', 'profit_day', 'status','is_index', 'is_hidden', 'member_id', 'credit_time', 'repayment_time'], 'integer'],
            [['min_money', 'max_money', 'step_money', 'has_money', 'stock_money', 'year_rate','recommond_rate','manage_rate', 'platform_income'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'platform_income' => Yii::t('app', '平台收益(元)'),
