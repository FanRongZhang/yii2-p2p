...
class ArrayHelper extends \yii\helpers\ArrayHelper
{
    ...
    public static function getPagedRows($query, $config = [])
    {
        ...
        {
            $rem=$count%$config['pageSize'];
            $divisor = ($count-$rem)/$config['pageSize'];
            $divisor = $rem!=0?$divisor+1:$divisor;
    ...
    public static function getPage($query,$page,$pageSize = 10){
        $pages = new Pagination(['totalCount' =>$query->count(), 'pageSize' => $pageSize,'page'=>$page-1]);
